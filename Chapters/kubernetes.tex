...
\begin{lstlisting}
kubectl expose deployment contact --port=9002 --target-port=9002 --external-ip=192.168.1.61 -l visualize="true",run=contact --dry-run --output=yaml > contact-svc.yaml
\end{lstlisting}
